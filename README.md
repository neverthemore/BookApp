Ниже представлен файл `README.md` в готовом виде. Вы можете скопировать его целиком и загрузить в корень вашего репозитория на GitHub.
...
- Установленная **Java 17+** (проверьте: `java -version`)
...
mvn test
```
или в IDEA нажмите правой кнопкой на папке `src/test/java` → **Run 'All Tests'**.

Тесты используют in-memory базу данных SQLite, что обеспечивает изоляцию и быстрое выполнение. Покрыты все основные сценарии:
- Добавление, поиск книг
- Регистрация читателей
- Выдача и возврат книг с проверкой количества копий
...
Просто скопируйте этот текст в файл `README.md` вашего репозитория. Форматирование сохранится, включая эмодзи, подсветку кода и структуру.

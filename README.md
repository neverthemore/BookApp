...
Скачайте драйвер SQLite JDBC с Maven Central и поместите в корневую папку проекта.
...
Откройте проект как Maven-проект (файл pom.xml).

Дождитесь загрузки зависимостей.

Нажмите правой кнопкой на файле Main.java → Run 'Main.main()'.
